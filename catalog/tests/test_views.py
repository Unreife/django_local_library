...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
        ...
        self.assertEqual(response.context['book_renewal_form'].initial['renewal_date'], date_3_weeks_in_future)
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response.context['book_renewal_form'], 'renewal_date', 'Invalid date - renewal in past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response.context['book_renewal_form'], 'renewal_date', 'Invalid date - renewal more than 4 weeks ahead')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_logged_in(self):
        ...
        self.assertTrue(login)  # Check login worked.
    ...
    def test_initial_date_of_death(self):
        ...
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
        self.assertIn('value="11/11/2023"', response.content.decode())
